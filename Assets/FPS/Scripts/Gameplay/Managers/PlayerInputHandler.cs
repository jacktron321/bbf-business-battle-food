...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        public bool GetShopButtonDown()
        {
            if (CanProcessInput())
            {
                return Input.GetButtonDown(GameConstants.k_ButtonShop);
            }

            return false;
        }

        public bool GetConfirmButtonDown()
        {
            if (CanProcessInput())
            {
                return Input.GetButtonDown(GameConstants.k_ButtonConfirm);
            }

            return false;
        }

        public bool GetConsumeInputHeld()
        {
            if (CanProcessInput())
            {
                return Input.GetButtonDown(GameConstants.k_ButtonConsume);
            }
            return false;
        }
        public bool GetConsumeInputReleased()
        {
            if (CanProcessInput())
            {
                return Input.GetButtonUp(GameConstants.k_ButtonConsume);
            }
            return false;
        }
