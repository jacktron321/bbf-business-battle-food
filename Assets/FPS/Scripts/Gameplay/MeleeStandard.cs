...
{
    public class MeleeStandard : ProjectileBase
    {
        ...
        void Update()
        {
            ...
            // Hit detection
            {
                ...
                // Sphere cast
                Vector3 newsize = new Vector3(lenght,height,width);
                Vector3 displacementSinceLastFrame = Tip.position - m_LastRootPosition;
                RaycastHit[] hits = Physics.BoxCastAll(m_LastRootPosition, newsize/2,
                    displacementSinceLastFrame.normalized, transform.rotation, displacementSinceLastFrame.magnitude, HittableLayers,
        ...
        void OnDrawGizmosSelected()
        {
            ...
            Vector3 newsize = new Vector3(lenght,height,width);
            Gizmos.DrawCube(transform.position, newsize/2);
        }
    }
}