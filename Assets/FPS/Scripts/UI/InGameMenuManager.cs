...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        [Tooltip("GameObject for the info menu")]
        ...
        void SetPauseMenuActivation(bool active)
        {
            ...
            if (MenuRoot.activeSelf)
            {
                ...
                Cursor.visible = true;
                Time.timeScale = 0f;
                //AudioUtility.SetMasterVolume(AudioUtility.GetMasterVolume()*VolumeWhenMenuOpen);
                AudioUtility.SetMasterVolume(VolumeSlider.value*VolumeWhenMenuOpen);
        ...
        public void OnShowInfoButtonClicked(bool show)
        {
            InfoImage.SetActive(show);
        }
    }
}